...
> Learning transferable visual representations without class labels using contrastive self-supervised learning.

This project implements **SimCLR with a modified ResNet-18** to investigate how useful visual representations can be learned without class labels.

The learned features are evaluated against **supervised learning** and a **random backbone**, followed by ablation studies on temperature and the projection head, and finally a cross-dataset transfer experiment on CIFAR-100.

## Key Results

| Experiment | Accuracy |
| --- | ---: |
| SimCLR Linear Probe (CIFAR-10) | **86.77%** |
| Supervised Learning (CIFAR-10) | **92.43%** |
| Random Backbone (CIFAR-10) | **41.83%** |
| SimCLR Transfer (CIFAR-100) | **50.05%** |
| Supervised Transfer (CIFAR-100) | **49.24%** |

**Key finding:** Although supervised learning achieved higher accuracy on CIFAR-10, SimCLR learned representations that transferred competitively to CIFAR-100 (**50.05% vs. 49.24%**) without using class labels during representation learning.
...
Image → Frozen Backbone → 512-D Representation
                          ├── kNN Evaluation
...
<p align="center">
  <img src="figures/simclr_loss_curve.png" width="48%">
  <img src="figures/simclr_knn_accuracy_curve.png" width="48%">
</p>

<p align="center">
  <em>NT-Xent training loss and kNN representation accuracy during SimCLR training.</em>
</p>
...
### kNN Accuracy under Different Temperatures

<p align="center">
  <img src="figures/simclr_temp01_knn_curve.png" width="32%">
  <img src="figures/simclr_knn_accuracy_curve.png" width="32%">
  <img src="figures/simclr_temp5_knn_curve.png" width="32%">
</p>

<p align="center">
  <em>T = 0.1 &nbsp;&nbsp; | &nbsp;&nbsp; T = 0.5 (Baseline) &nbsp;&nbsp; | &nbsp;&nbsp; T = 5</em>
</p>
...
<p align="center">
  <img src="figures/cifar100_transfer_comparison.png" width="65%">
</p>

<p align="center">
  <em>Linear probing performance on CIFAR-100 using frozen representations learned on CIFAR-10.</em>
</p>
...
│
├── notebooks/
│   ├── simclr_baseline.ipynb
│   ├── supervised_baseline.ipynb
│   ├── random_backbone_baseline.ipynb
│   ├── Temperature Ablation：T = 0.1.ipynb
│   ├── Temperature Ablation：T = 5.ipynb
│   ├── simclr_no_projector.ipynb
│   ├── projector_representation.ipynb
│   └── cross_dataset_cifar100.ipynb
│
├── figures/
│   ├── simclr_loss_curve.png
│   ├── simclr_knn_accuracy_curve.png
│   ├── simclr_temp01_knn_curve.png
│   ├── simclr_temp01_loss_curve.png
│   ├── simclr_temp5_knn_curve.png
│   ├── simclr_temp5_loss_curve.png
...
Model checkpoints and downloaded CIFAR datasets are excluded from the repository.